        ...
        <>
            ...
            <section className='policySection'>
                <div className="row container">
                    ...
                    <p>
                        This official website of the Food Processing Corporation of India (FPCI) has been developed to disseminate information to the general public. Though all efforts have been made to ensure the accuracy and correctness of the content on this website, the same should not be construed as a statement of law or used for any legal purposes.
                        The web contents are subject to change without any prior notice from Food Processing Corporation of India (FPCI) website.
                        In no event will Food Processing Corporation of India (FPCI)  be liable for any expense, loss or damage including, without limitation, indirect or consequential loss or damage, or any expense, loss or damage whatsoever arising from use, or loss of use, of data, arising out of or in connection with the use of this website. In case of any variation between what has been produced on the website about Act, Rules, Regulations, Policy Statements etc and that contained in the relevant Act, Rules, Regulations, Policy Statements etc, with the department the latter shall prevail.
                        Links to other websites that have been included on this website are provided for public convenience only. Food Processing Corporation of India (FPCI) is not responsible for the contents or reliability of linked websites and does not necessarily endorse the view expressed within them. It is also not guaranteed that the availability of such linked pages at all times.
